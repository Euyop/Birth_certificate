...
<head>
    ...
    <title>Login | Apply For Birth Certificate Services</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <h3 style="font-weight: bold;color: black">Register Birth Certificate</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <p style="text-align: left;"><a href="register.php">Create New account ? Sign Up</a></p>
