...
<head>
    ...
    <title>Dashboard | Apply For Birth Certificate Services</title>
                            ...
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range">
                                        ...
                                        <a class="block text-center" href="new-birth-application.php"><strong style="color:blue">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                            ...
                            <div class="income-dashone-total orders-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range order-cl">
                                        <a class="block text-center" href="verified-birth-application.php"><strong style="color:blue">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
