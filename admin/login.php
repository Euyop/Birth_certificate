...
<head>
    ...
    <title>Login | Admin Birth Certificate Service Page </title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <h3 style="font-weight: bold;color: black">Admin Birth Certificate Login Form</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="text" placeholder="Admin Name" required="true" name="username" value="<?php if(isset($_COOKIE["user_login"])) { echo $_COOKIE["user_login"]; } ?>" >
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                           ...
                                           <p style="text-align:right"><a href="../index.php">Back To Home</a></p>
                                        </div>
