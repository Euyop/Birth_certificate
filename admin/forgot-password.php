...
<head>
    ...
    <title>Forgot Password | Apply For Birth Certificate Services</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                               <h3 style="font-weight: bold;color: black">Password Backup</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <p style="text-align:center"><a href="login.php">Already Have Account ? Sign In</a></p>
                                        </div>
